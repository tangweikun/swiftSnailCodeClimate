...
export const riskFactors = {
  ...
  options: [
    ...
    {
      key: 'DYSLIPIDEMIA',
      label: '血脂异常：总胆固醇≥5.7 mmol/L（220mg/dl）或低密度脂蛋白胆固醇>3.3 mmol/L(130 mg/dl)或高密度脂蛋白胆固醇<1.0 mmol/L（40 mg/dl）',
    },
    {
...
export const targetOrganDamage = {
  ...
  options: [
    ...
    },
    {
      ...
      label: '估算的肾小球滤过率降低[eGFR<60ml/(min*1.73m2)]或血清肌酐轻度升高：男性115-133μmol/L（1.3-1.5mg/dl）,女性107-124μmol/L（1.2-1.4mg/dl）',
    },
    {
